...
using WebSovelluksetFinal.Models.AccountViewModels;
    ...
    {//asdfasdf
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Adress = model.Adress, BillingAddress = model.BillingAddress, SizeOfHouse = model.SizeOfHouse, HouseTypeID = model.HouseTypeID};
                ...
                { 
                    ...
                    _logger.LogInformation("User created a new account with password.");
                    return RedirectToLocal(returnUrl);//ayayay
                }
                AddErrors(result);
            }
